(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		return this.each(function() {
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left" placeholder="Enter Email" style="padding-bottom: 2%;padding-left: 5%;" />').on('keyup', function(e) { // input
